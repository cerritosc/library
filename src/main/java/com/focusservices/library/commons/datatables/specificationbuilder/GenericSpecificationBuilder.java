package com.focusservices.library.commons.datatables.specificationbuilder;
...
public class GenericSpecificationBuilder<E> {
     ...
     * @param <E>
     * @return this
     * @throws IllegalArgumentException in case the given clazz is {@link Number}.
     */
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.equals("addresses.city", cityName, {@link RelationType} RelationType.TO_MANY)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key          field name
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.like("department.name", departmentName, {@link RelationType} RelationType.TO_ONE)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key   field name
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.in("skills.name", Arrays.asList("JAVA", "RUBY"), {@link RelationType} RelationType.TO_MANY)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.lessThan("wage.amount", maxWageAmount, {@link RelationType} RelationType.TO_ONE)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key   field name
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.lessThanOrEqualTo("wage.amount", maxWageAmount, {@link RelationType} RelationType.TO_ONE)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key   field name
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.greaterThan("wage.amount", minWageAmount, {@link RelationType} RelationType.TO_ONE)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key   field name
     ...
     * <blockquote><pre>
     *     GenericSpecificationBuilder.of(Person.class)
     *     	.greaterThanOrEqualTo("wage.amount", minWageAmount, {@link RelationType} RelationType.TO_ONE)
     *     	.build();
     * </pre></blockquote>
     *
     * @param key   field name
    ...
    /**
     * Adds a new {@link Specification} to the specifications list <b>directly</b>
     *
     * @param specification
     * @return
     */
    ...
    public GenericSpecificationBuilder<E> customFunction(String functionName, String[] fieldNames, String... params) {
        ...
        for (String fieldName : fieldNames) {
            ...
            final Specification<E> fieldSpecification = (root, query, criteriaBuilder) -> {
                ...
                final Expression<?>[] paramsExpression = parameterExpressions.toArray(new Expression<?>[]{});
                final Expression<Boolean> sqlFunction = criteriaBuilder.function(functionName, Boolean.class, paramsExpression);
    ...
    /**
     * <p>
     * Generates a {@link GenericSpecification} object for each given filter criteria paramater
    ...
    public Specification<E> build() {
        if (filterCriteriaList.isEmpty() && customSpecifications.isEmpty()) {
            return null;
        }
        ...
        return new GenericSpecificationContainer<>(specificationResult, parameters);
    }
